...
export default tseslint.config(
  ...
  // Generated by `supabase gen types typescript`; committed verbatim so regeneration
  // produces no diff churn. Formatting it would be undone by the next generation, and
  // its unions trip no-redundant-type-constituents, which is not auto-fixable.
