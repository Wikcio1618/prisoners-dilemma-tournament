...
- [x] 2.1 All tests pass: `npm run test` — efe6091
- [x] 2.2 Linting passes: `npm run lint` — efe6091
- [x] 2.3 Build succeeds after the `match-room.ts` extraction: `npm run build` — efe6091
- [x] 2.4 Drift tests fail loudly when a constant is edited, then revert — efe6091

#### Manual

- [x] 2.5 Dev match-room harness still completes a round after the parser extraction — efe6091
- [x] 2.6 A malformed WebSocket frame is still rejected as before — efe6091
...
- [x] 4.1 All properties hold across the full range: `npm run test` — 34d955e
- [x] 4.2 Property tests exercise n=2 through n=50 without a counterexample — 34d955e
- [x] 4.3 Linting and build pass: `npm run lint`, `npm run build` — 34d955e

#### Manual

- [x] 4.4 The n=4 schedule matches the hand-trace in the prior review — 34d955e
- [x] 4.5 The oracle module is confirmed unreferenced by any shipped code path — 34d955e
...
- [x] 6.1 Full suite passes: `npm run test` — 9a02b30
- [x] 6.2 Lint and build pass: `npm run lint`, `npm run build` — 9a02b30
- [x] 6.3 No `TBD — see §3 Phase 1` markers remain in `test-plan.md` — 9a02b30

#### Manual

- [x] 6.4 §6.1 answers "how do I add a test for a derived value here?" standalone — 9a02b30
- [x] 6.5 §3 Phase 1 reads `complete` and pairing appears under Phase 2 — 9a02b30
- [x] 6.6 `change.md` records the payoff matrix decision findably — 9a02b30
