/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2dcc2915dc4115315b6372fb26592314)
// Runtime types generated with workerd@1.20260507.1 2026-05-08 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		SUPABASE_URL: string;
		SUPABASE_KEY: string;
		MATCH_ROOM: DurableObjectNamespace<import("./src/worker").MatchRoom>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_KEY">> {}
}
